    ...
    private class SaveButtonListener implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent event) {
            ...
            if (title.isEmpty() || author.isEmpty() || amount <= 0 || price <= 0){
                adminView.displayAlertMessage("Save Error", "Problem at Title or Author fields", "Can not have empty Author or Title fields. Please fill in the fields before submitting Save!");
    ...
    private class SaleButtonListener implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent event) {
            ...
            if (bookTitle.isEmpty() || quantity == 0) {
                adminView.displayAlertMessage("Error", "Problem at fields title, quantity", "Can not have empty Title or quantity.");
